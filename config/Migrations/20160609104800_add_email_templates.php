...
class AddEmailTemplates extends AbstractMigration
{
    ...
    public function change()
    {
        ...
        $table
            ...
            ->addColumn('from', 'string', ['null'=>false])        #: Email or array of sender. See Email::from().
            ->addColumn('sender', 'string', ['null'=>true])       #: Email or array of real sender. See Email::sender().
            ->addColumn('to', 'string', ['null'=>false])          #: Email or array of destination. See Email::to().
            ->addColumn('cc', 'string', ['null'=>true])           #: Email or array of carbon copy. See Email::cc().
            ->addColumn('bcc', 'string', ['null'=>true])          #: Email or array of blind carbon copy. See Email::bcc().
            ...
            ->addColumn('message_html', 'text', ['null'=>true])   #: Message body for HTML messages (OPTIONAL)
            ->addColumn('message_text', 'text', ['null'=>false])  #: Message body for TEXT-ONLY messages (REQUIRED)
            ...
            ->addColumn('viewVars', 'string', ['null'=>true])     #: If you are using rendered content, set the array with variables to be used in the view. See Email::viewVars().
            ->addColumn('attachments', 'string', ['null'=>true])  #: List of files to attach. See Email::attachments().
            ->addColumn('emailFormat', 'string', ['null'=>true])  #: Format of email (html, text or both). See Email::emailFormat().
